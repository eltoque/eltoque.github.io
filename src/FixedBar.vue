        ...
        <div v-show="isFixed" :class="{ 'is-fixed': isFixed }">
                <div class="top-bar row">
                    ...
                    <div :class="(hideNumbers)?'col-md-3 text-center':'col-md-6 text-center'">
                        <div :class="{grow: !hideNumbers}" class="menu-phase"><span v-scroll-to="'#phase3'" :class="{actives: phase=='III'}">Fase III</span> - <span v-scroll-to="'#phase2'" :class="{actives: phase=='II'}">Fase II</span> - <span v-scroll-to="'#phase1'" :class="{actives: phase=='I'}">Fase I</span></div>
                    </div>
